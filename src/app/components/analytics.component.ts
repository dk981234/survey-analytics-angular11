                    ...
                    elements: [
                        {
                            ...
                            name: 'custom',
                            title:
                                'This is a custom question with two values - min and max'
                        },
                        {
                            type: 'matrix',
                            name: 'Quality',
                            ...
                            choices: [
                                {
                                    value: 'ISV',
                                    text:
                                        'ISV (building commercial/shrink wrapped software)'
                                },
                                {
                                    value: 'Consulting',
                                    text:
                                ...
                                },
                                {
                                    value: 'Hobbyist',
                                    text:
                                        'Hobbyist (develop apps for personal use)'
                                }
                            ],
                            colCount: 2
                        },
                        {
                            ...
                            title:
                                'How many software developers are in your organization?',
